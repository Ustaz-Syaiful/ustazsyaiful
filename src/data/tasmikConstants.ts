...
export const TASMIK_OFFICIAL_DATA = {
  jawi: {
    ...
    objectives: [
      ...
      '3. ممباخ سورة دغن بتول دان مغيكوت مخرج سرتا برتجويد.'
    ],
    successCriteria: [
    ...
    mainActivities: [
      ...
      '2. التيه توبي مثبوت/ممباخ كلمة، فوتوغن اية سورة / اقرا مغيكوت تاهف باجأن موريد سخارا اينديؤيدو دغن بتول دان برتجويد.',
